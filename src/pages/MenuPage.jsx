    ...
    <div style={{
      ...
      <header style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, minWidth: 0 }}>
          ...
          <div style={{ minWidth: 0 }}>
            ...
            }}>{parametres?.nom_restaurant || 'Kwetu'}</h1>
            {!isMobile && (
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: isMobile ? 8 : 12, flexShrink: 0 }}>
          ...
          <button onClick={() => setShowPanier(true)} style={{
            ...
            whiteSpace: 'nowrap',
            boxShadow: totalItems > 0 ? `0 4px 16px rgba(139,195,74,0.35)` : 'none',
          }}>
            🛒 {!isMobile && L.panier}
            {totalItems > 0 && (
              <span style={{
      ...
      {showAppel && (
        <div style={{
          ...
          background: 'rgba(44,74,30,0.50)', backdropFilter: 'blur(4px)',
      ...
      {toast && (
        <div style={{
          ...
          boxShadow: '0 8px 24px rgba(44,74,30,0.25)',
